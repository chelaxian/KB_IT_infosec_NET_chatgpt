...
Данный проект позволяет автоматически разлогиниваться и залогиниваться на YouTube по заданному циклу. Скрипт реализован для расширений [Violentmonkey](https://violentmonkey.github.io/) (аналогично можно использовать Tampermonkey) в браузере Chrome. Для автозаполнения данных на странице логина рекомендуется использовать LastPass или аналогичный менеджер паролей.

## Необходимые расширения

1. **Violentmonkey**  
   - [Ссылка на Chrome Web Store](https://chrome.google.com/webstore/detail/violentmonkey/jinjaccalgkegednnccohejagnlnfdag)  
   - Устанавливается для управления пользовательскими скриптами.

2. **LastPass** (или аналогичный менеджер паролей)  
   ...
   - Устанавливается для автоматического автозаполнения логина и пароля на странице входа Google.

## Установка и настройка

### Установка Violentmonkey и скрипта
...
2. **Создание нового скрипта:**
   ...
   - Удалите содержимое шаблона и вставьте финальный скрипт, приведённый ниже.
...
2. **Настройка аккаунта:**
   - После установки нажмите на иконку LastPass в панели инструментов браузера.
...
3. **Сохранение учетных данных:**
   ...
   - Введите свои учетные данные и, когда браузер предложит сохранить пароль, согласитесь. LastPass сохранит их и будет использовать для автозаполнения при последующих входах.
   
4. **Включение автологина:**
   - **Важно!** По умолчанию функция автологина в LastPass отключена.
   - Чтобы включить автологин, откройте настройки расширения LastPass:
     - Нажмите на иконку LastPass → **Расширенные настройки** (или **Advanced Options**).
     - Найдите опцию "Автологин" (или "Auto-login") и поставьте галочку для её активации.
...
**Важно:**  
Убедитесь, что в настройках LastPass включена функция автологина (Auto-login). Это можно сделать, открыв настройки расширения и отметив соответствующую галочку.
