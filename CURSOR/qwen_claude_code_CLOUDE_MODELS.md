...
Структура: **§11.1–11.4** — терминал, claude-mem, Node-прокси NIM, динамический Qwen; **§11.5–11.6** — пресеты NIM и Z.AI; **§11.7–11.8** — лаунчер и сессия Claude; **§11.9–11.11** — списки моделей, TUI, мастер «Другая модель»; **§11.12** — `update-cloud-shortcuts.ps1` (в файле могут быть старые абсолютные пути — замените на `$RepoRoot`); **§11.13** — меню Qwen; **§11.14** — Python-слой NIM для free-claude-code.
...
### 11.12. `update-cloud-shortcuts.ps1` (ярлыки Cloud (длинные имена); замените пути)

```powershell
[CmdletBinding()]
param(
  [string]$DesktopPath = "C:\Users\chelaxian\Desktop",
  [string]$VaultPath = "C:\Users\chelaxian\Documents\Obsidian Vault",
  [string]$ObsidianExe = "C:\Users\chelaxian\AppData\Local\Programs\Obsidian\Obsidian.exe"
)
...
$ws = New-Object -ComObject WScript.Shell
$launcherClaude = "I:\qwen-local-setup\scripts\run-claude-cloud-launcher.ps1"
$launcherQwen = "I:\qwen-local-setup\scripts\run-qwen-code-launcher.ps1"
...
function Ensure-ClaudeCloudUnifiedShortcut {
  ...
  $sc.WorkingDirectory = "I:\qwen-local-setup"
  $sc.WindowStyle = 1
  $sc.IconLocation = "C:\Users\chelaxian\Pictures\claudecode.ico,0"
