## Скрипт для перевода комментариев в коде и текста в функциях вывода (консоль, логи, сообщения в телеграм-чат), а также для очистки кода от лишних новых строк и исправления лишних/недостающих импортов модулей
